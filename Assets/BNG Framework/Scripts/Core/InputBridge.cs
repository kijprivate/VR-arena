...
namespace BNG {
    ...
    public class InputBridge : MonoBehaviour {
        ...
        public virtual void UpdateSteamInput() {
            ...
            Debug.LogError("1. " + SteamVR_Actions.vRIF_LeftThumbstickDown.renderModelComponentName);
            Debug.LogError("2. " + SteamVR_Actions.vRIF_LeftThumbstickDown.GetShortName());
